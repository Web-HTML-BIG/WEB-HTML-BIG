            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="/sanpham_nike.php">Sản phẩm </a>
            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__left product__thumb nice-scroll">
                            ...
                            <a class="pt_active" href="#product-1">
                                <img src="img/product/details/detail1.png" alt="">
                            </a>
                            <a class="pt" href="#product-2">
                                <img src="img/product/details/detail2.png" alt="">
                            </a>
                            <a class="pt" href="#product-3">
                                <img src="img/product/details/detail3.png" alt="">
                            </a>
                            <a class="pt" href="#product-4">
                                <img src="img/product/details/detail4.jpg" alt="">
                            </a>
                            <a class="pt" href="#product-5">
                                <img src="img/product/details/detail5.png" alt="">
                            </a>
                            <a class="pt" href="#product-6">
                        ...
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                ...
                                <img data-hash="product-2" class="product__big__img" src="<?php echo $row['URL'];?>" alt="ảnh sản phẩm">
                                <img data-hash="product-3" class="product__big__img" src="<?php echo $row['URL'];?>" alt="ảnh sản phẩm">
                                <img data-hash="product-4" class="product__big__img" src="<?php echo $row['URL'];?>" alt="ảnh sản phẩm">
                                <img data-hash="product-5" class="product__big__img" src="<?php echo $row['URL'];?>" alt="ảnh sản phẩm">
                                <img data-hash="product-6" class="product__big__img" src="<?php echo $row['URL'];?>" alt="ảnh sản phẩm">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price"><?php echo $row['GIABAN']; ?> đ <span><?php echo $row['GIABANKM']; ?> đ</span></div>
                        ...
                        <div class="product__details__button">
                            ...
                            <button class="cart-btn" type="submit"><a>Add to cart</a></button>
                            </form>
                        </div>
