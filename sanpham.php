        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                                ...
                                $sql = "SELECT * FROM sp JOIN loaisp ON loaisp.IDLSP = sp.IDLSP WHERE loaisp.TENLOAI = '$product' LIMIT $limit OFFSET $offset";
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <br> 
                                    <div class="product__price"><?php echo number_format($row['GIABANKM'],0,'','.') ?>đ <span><?php echo $row['GIABAN'] ?>đ</span></div>
                                </div>
                            </div>
                        </div>
                                <?php 
